...
void Component::draw()
{
    ...
    if ( backgroundTexture_ )
    {
        ...
        SDL::renderCopy(backgroundTexture_, baseViewInfo.BackgroundAlpha, NULL, &rect, baseViewInfo, page.getLayoutWidth(baseViewInfo.Layout), page.getLayoutHeight(baseViewInfo.Layout));
    }
}
